...
if (!isset($_GET['annID']) || empty($_GET['annID'])) {
...
$ann_query = "SELECT a.*, c.clubName, c.clubID, c.clubLogo, l.lectName, l.lectProfileImg
...
<head>
    ...
    <title><?php echo htmlspecialchars($announcement['anntitle']); ?></title>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-sm breadcrumbs hidden sm:inline-block">
                            <ul>
                                ...
                                <li><a href="club_profile.php?clubID=<?php echo $announcement['clubID']; ?>"><?php echo htmlspecialchars($announcement['clubName']); ?></a></li>
                                <li>Announcement</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="card bg-base-100 shadow-xl">
                            ...
                            <div class="card-body border-b">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 class="font-bold"><?php echo htmlspecialchars($announcement['clubName']); ?></h3>
                                        <p class="text-sm text-gray-500">by <?php echo htmlspecialchars($announcement['lectName']); ?></p>
                                        <p class="text-xs text-gray-400"><?php echo date('F j, Y \a\t g:i A', strtotime($announcement['annPosted_at'])); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Title -->
                            <div class="card-body">
                                <h1 class="text-3xl font-bold mb-4"><?php echo htmlspecialchars($announcement['anntitle']); ?></h1>
                                ...
                                <figure class="relative">
                                    <div class="carousel w-full rounded-t-2xl overflow-hidden bg-black" id="mediaCarousel">
                                        <?php foreach ($media_items as $index => $media): ?>
                                            <div id="slide<?php echo $index + 1; ?>" class="carousel-item relative w-full min-h-[400px] flex items-center justify-center">
                    ...
                    <div class="lg:col-span-1">
                        ...
                        <div class="card bg-base-100 shadow-xl mb-6 sticky top-4">
                            <div class="card-body">
                                <h3 class="card-title text-lg">About This Club</h3>
                                <div class="divider my-2"></div>
                                <div class="space-y-3">
                                    <div>
                                        <p class="text-sm font-semibold text-gray-600">Club Name</p>
                                        <p class="font-bold"><?php echo htmlspecialchars($announcement['clubName']); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-gray-600">Advisor</p>
                                        <p><?php echo htmlspecialchars($announcement['lectName']); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-semibold text-gray-600">Posted On</p>
                                        <p><?php echo date('F j, Y', strtotime($announcement['annPosted_at'])); ?></p>
                                    </div>
                                    <div>
                                ...
                                <div class="divider my-2"></div>
                                <a href="club_profile.php?clubID=<?php echo $announcement['clubID']; ?>" class="btn btn-primary btn-sm btn-block">
                                    View Club Profile
                                </a>
                            </div>
                        </div>
