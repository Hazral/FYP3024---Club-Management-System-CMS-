...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2025 at 05:12 PM
...
(17, '08:00:00', '2025-11-16', '2025-11-12 20:11:48', 'test', 'Leadership/Team Building', 9, NULL, NULL, 'test3');
...
(11, 'Accounting Club Welcomes New Semester', 'Kelab Accounting would like to welcome all UPTM students to the new semester. Follow our updates for academic tips, accounting-related sharing, and club information.', '2025-11-10 14:13:39', 9, NULL, NULL, 0, 'Public'),
(12, 'Reminder to Update Member Information', 'All registered members are reminded to update their personal details in the membership record. This ensures smooth communication throughout the semester.', '2025-11-10 14:15:23', 9, NULL, NULL, 0, 'Private'),
...
(19, 'Club Information for New Students', 'Kelab Futsal is open to new members. Students may follow our page for updates, announcements, and club-related information throughout the semester.', '2025-11-10 14:33:36', 13, 'uploads/announcements/announcement_691187402272d.jpg', NULL, 0, 'Public'),
...
(11, 'Financial Literacy Workshop: “Managing Money as a Student”', 'An introductory workshop on budgeting, savings, and financial planning designed for all UPTM students.', 'Bilik Seminar 1, Block B', '2025-11-10 19:26:02', 9, NULL, NULL, 0, '10:00:00', '2025-11-01', 'Public', 100),
...
(9, 'Kelab Accounting', 'A club for accounting students to enhance financial literacy, participate in academic workshops, and prepare for industry certifications.', 6, 100, '2025-11-10 13:26:54', 'uploads/clubs/logos/club_logo_9_1762753329.jpg', 'uploads/clubs/banners/club_banner_9_1762753697.png'),
...
(6, 'shazwan@gmail.com', 'MUHAMMAD SHAZWAN', '$2y$10$W3FVfsADtB2phO5j6eQ.tOf1Rn.JKiTSGlNxrLR/Xo2v6qN1BYL0q', 'Faculty of Business & Accountancy', NULL),
...
--
ALTER TABLE `casactivity_attendance`
  MODIFY `actAttendanceID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `casannouncement`
--
ALTER TABLE `casannouncement`
  MODIFY `annID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `events_participant`
  MODIFY `partID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `student`
  MODIFY `studID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
