...
$query = "SELECT a.actID, a.actTitle, a.actDescription, a.actImg, a.actVid, a.actDate, a.actTime, a.actPosted_at, a.actType,
...
$stmt = $conn->prepare($query);
$stmt->execute([$student_id, $activity['clubID']]);
...
$query = "SELECT actID, actTitle, actPosted_at, actImg, actType 
          FROM casactivity 
          WHERE clubID = ? AND actID != ? 
          ORDER BY actPosted_at DESC 
          LIMIT 3";
$stmt = $conn->prepare($query);
$stmt->execute([$activity['clubID'], $activity_id]);
$related_activities = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
$total_comments = count($parent_comments);
...
$activityTypeBadges = [
    'Recruitment/Orientation' => ['bg' => 'bg-blue-500', 'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'],
    'Leadership/Team Building' => ['bg' => 'bg-purple-500', 'icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z'],
    'Meeting' => ['bg' => 'bg-green-500', 'icon' => 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
    'Social/Gathering' => ['bg' => 'bg-orange-500', 'icon' => 'M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z']
];

$typeBadge = $activityTypeBadges[$activity['actType']] ?? ['bg' => 'bg-gray-500', 'icon' => 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z'];
?>
...
<head>
    ...
    <title><?php echo htmlspecialchars($activity['actTitle']); ?> - Student Club Management</title>
...
<body class="bg-base-200">
                        ...
                        <div class="card bg-base-100 shadow-xl animate-fade-in">
                            ...
                            <div class="card-body">
                                ...
                                <div class="flex items-center gap-2 mb-4 flex-wrap">
                                    <span class="badge <?php echo $typeBadge['bg']; ?> text-white border-none gap-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo $typeBadge['icon']; ?>" />
                                        </svg>
                                        <?php echo htmlspecialchars($activity['actType']); ?>
                                    </span>
                                    <span class="text-sm text-gray-500">
                                        Posted on <?php echo date('F j, Y \a\t g:i A', strtotime($activity['actPosted_at'])); ?>
                                    </span>
                                </div>
                                ...
                                <div class="flex gap-4 mb-6 flex-wrap">
                                    <div class="flex items-center gap-2 text-gray-600">
                                        ...
                                        <span class="font-semibold"><?php echo date('l, F j, Y', strtotime($activity['actDate'])); ?></span>
                                    </div>
                                    <div class="flex items-center gap-2 text-gray-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd" />
                                        </svg>
                                        <span class="font-semibold"><?php echo date('g:i A', strtotime($activity['actTime'])); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3 mb-6 p-4 bg-base-200 rounded-lg">
                                    ...
                                    <div>
                                        <h3 class="font-bold">
                                            <a href="club_profile.php?id=<?php echo $activity['clubID']; ?>" class="link link-hover text-purple-600">
                                                <?php echo htmlspecialchars($activity['clubName']); ?>
                                            </a>
                                        </h3>
                                        <?php if (!empty($activity['lectName'])): ?>
                                            <p class="text-sm text-gray-600">Advisor: <?php echo htmlspecialchars($activity['lectName']); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="content-section prose max-w-none">
                                    <h2 class="text-2xl font-bold mb-3">Activity Details</h2>
                                ...
                                <div class="card-actions justify-between items-center">
                                    <?php if (!$is_member): ?>
                                        <a href="club_detail.php?id=<?php echo $activity['clubID']; ?>" 
                                                        ...
                                                        <div class="flex gap-3">
                                                            <div class="avatar">
                                                                <div class="w-8 h-8 rounded-full">
                                                                    <?php if (!empty($current_student['studProfileImg'])): ?>
                                                                    <img src="../<?php echo htmlspecialchars($current_student['studProfileImg']); ?>" 
                                                                        alt="<?php echo htmlspecialchars($current_student['studName']); ?>">
                                                                    <?php else: ?>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h4 class="font-bold"><?php echo htmlspecialchars($activity['clubName']); ?></h4>
                                            <?php if (!empty($activity['lectName'])): ?>
                                            <p class="text-xs text-gray-500">Advisor: <?php echo htmlspecialchars($activity['lectName']); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    
                                    <p class="text-sm text-gray-600">
                                        <?php echo htmlspecialchars($activity['clubDescription']); ?>
                                    </p>
                                    ...
                                    <a href="club_profile.php?id=<?php echo $activity['clubID']; ?>" 
                        ...
                        <div class="card bg-base-100 shadow-xl animate-fade-in">
                            <div class="card-body">
                                ...
                                <div class="space-y-4">
                                    <?php foreach ($related_activities as $related): ?>
                                    <a href="activity_post.php?id=<?php echo $related['actID']; ?>" 
                                    class="block hover:bg-base-200 p-3 rounded-lg transition">
                                        <div class="flex gap-3">
                                            <?php if (!empty($related['actImg'])): ?>
                                            <div class="avatar">
                                                <div class="w-16 h-16 rounded">
                                                    <img src="../<?php echo htmlspecialchars($related['actImg']); ?>" 
                                                        alt="<?php echo htmlspecialchars($related['actTitle']); ?>"
                                            ...
                                            <div class="flex-1">
                                                <h4 class="font-bold text-sm line-clamp-2">
                                                    <?php echo htmlspecialchars($related['actTitle']); ?>
                                                </h4>
                                                <span class="badge badge-xs <?php echo $activityTypeBadges[$related['actType']]['bg'] ?? 'bg-gray-500'; ?> text-white border-none mt-1">
                                                    <?php echo htmlspecialchars($related['actType']); ?>
                                                </span>
                                                <p class="text-xs text-gray-500 mt-1">
                                                    <?php echo date('M j, Y', strtotime($related['actPosted_at'])); ?>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
    ...
    function getPostInfo() {
        ...
        return { postType: 'activity', postId };
    }
    ...
    function shareActivity() {
        ...
        const title = '<?php echo addslashes($activity['actTitle'] ?? ''); ?>';
